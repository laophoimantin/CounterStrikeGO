...
{
    public class NewEventDispatcher : Singleton<NewEventDispatcher> 
    {
...
public static class NewEventDispatcherExtensions
{
    ...
    {
        NewEventDispatcher.Instance.Subscribe<T>(callback);
    }
    ...
    {
        NewEventDispatcher.Instance.SendEvent(eventData);
    }
}